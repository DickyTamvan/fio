...
def user():
    os.system('clear')
    banner()
    print ('[+]MEMBUAT API KEY ...');time.sleep(3)
    print ("[+]BERHASIL");time.sleep(0.07)
    id = uuid.uuid4().hex[:25]
    idg = open('licensed.log', 'w')
    idg.write(id)
    idg.close()
    print ("[+]API KEY : \033[1;92m"+ id);time.sleep(0.07)
    print ('\033[1;97m[+]API KEY BELUM DI KONFIRMASI');time.sleep(0.07)
    print ('\033[1;97m[+]HUBUNGIN ADMIN');time.sleep(0.07)
    input ('\033[1;97m[+]KlIK ENTER UNTUK KONFIRMASI API KEY');time.sleep(0.07)
    os.system('am start https://wa.me/6283185392138?text=Konfirmasi%20Saya%20Dengan%20ID:%20' + id + ' >/dev/null')
    time.sleep(1)
    os.sys.exit()
def user1():
    try:
      j = open('licensed.log', 'r').read()
      r = requests.get("https://github.com/DickyTamvan/licensi/blob/main/Login%20licensi").text.strip() # Jangan Di ganti bro'i nanti error
      if j in r:
          os.system("clear")
          banner()
          print("Login Status : \x1b[92mLengkap\x1b[0m")
          time.sleep(1)
          return
      else:
          os.system("clear")
          banner()
          print ('[!]MEMBUAT API KEY :\x1b[91m GAGAL \x1b[0m');time.sleep(0.07)
          print ('[+]API KEY TIDAK DI KONFIRMASI');time.sleep(0.07)
          print ('[+]HUBUNGIN ADMIN');time.sleep(0.07)
          input ('[+]KLIK ENTER UNTUK KONFIRMASI API KEY');time.sleep(0.07)
          os.system('am start https://wa.me/6283185392138?text=Tolong%20konfirmasi%20saya%20dengan%20ID:%20' + j + ' >/dev/null')
          os.sys.exit()
